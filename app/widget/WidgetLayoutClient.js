...
/**
 * After first paint, clear any non-transparent backgrounds on direct body children
 * (Next.js root wrappers) so the host page shows through the iframe.
 */
export default function WidgetLayoutClient({ children }) {
  useLayoutEffect(() => {
