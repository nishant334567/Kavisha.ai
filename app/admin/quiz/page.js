      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6 justify-end">
          ...
          <button
            ...
            className="whitespace-nowrap rounded-full bg-muted-bg px-4 py-2.5 text-sm font-medium text-highlight font-baloo"
          >
            + Add new
          </button>
        </div>
        ...
        {quizzes.length === 0 ? (
          <div className="rounded-xl border border-border bg-card py-16 text-center shadow-sm">
            ...
            <p className="mb-6 text-sm text-muted font-baloo">
              Create your first quiz or survey to get started
            </p>
            <button
              onClick={() => router.push("/admin/quiz/new")}
              className="px-6 py-2.5 bg-teal-700 text-white rounded-lg hover:bg-teal-800 transition-colors font-medium font-baloo"
            >
              Create Quiz
            </button>
          </div>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-start justify-between gap-2 mb-3">
                    <h3 className="min-w-0 flex-1 pr-2 text-lg font-semibold text-foreground font-baloo">
                      {quiz.title || "Quiz title"}
                    </h3>
                    <div className="flex items-center gap-1.5 shrink-0 flex-wrap justify-end">
                      <span
                        className={`px-2 py-0.5 text-xs font-medium rounded-full font-baloo ${
                      ...
                      <span
                        className={`px-2.5 py-1 text-xs font-normal rounded-full whitespace-nowrap font-baloo ${
                          quiz.type === "quiz"
                  ...
                  {/* Subtitle */}
                  {quiz.subtitle && (
                    <p className="mb-4 line-clamp-2 text-sm text-muted font-baloo">
                      {quiz.subtitle}
                    </p>
                  )}
                ...
                <div className="mt-4 flex flex-wrap gap-2 border-t border-border pt-4">
                  {isDraft ? (
                    <>
                      <button
                        ...
                        className="min-w-0 flex-1 rounded-full bg-highlight px-4 py-2.5 text-sm font-medium text-white font-baloo hover:opacity-90"
                      >
                        Edit draft
                      </button>
                      <button
                        ...
                        className="flex min-w-0 flex-1 items-center justify-center gap-2 rounded-full bg-muted-bg px-4 py-2.5 text-sm font-medium text-highlight font-baloo hover:bg-background disabled:cursor-not-allowed disabled:opacity-50"
                    ...
                    <button
                      ...
                      className="flex min-w-0 flex-1 items-center justify-center gap-2 rounded-full bg-muted-bg px-4 py-2.5 text-sm font-medium text-highlight font-baloo shadow-sm"
                    >
                  ...
                  <button
                    ...
                    className="flex shrink-0 items-center justify-center gap-2 rounded-full px-4 py-2.5 text-sm font-medium text-red-600 font-baloo hover:bg-muted-bg disabled:opacity-50"
                    title="Delete quiz"
                  >
